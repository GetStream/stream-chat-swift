...
final class GuestUserTokenRequestPayload_Tests: XCTestCase {
    func test_guestUserTokenRequestPayload_isEncodedCorrectly_withDefaultExtraData() throws {
        ...
        let payload = GuestUserTokenRequestPayload(userId: .unique, extraData: NameAndImageExtraData(name: name, imageURL: imageURL))
    ...
    private func verify<ExtraData: UserExtraData>(_ payload: GuestUserTokenRequestPayload<ExtraData>, isEncodedAs expected: [String: Any]) throws {
        // Encode the user
