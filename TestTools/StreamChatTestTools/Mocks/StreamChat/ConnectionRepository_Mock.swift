...
final class ConnectionRepository_Mock: ConnectionRepository, Spy, @unchecked Sendable {
    ...
    convenience init(client: ChatClient) {
        self.init(
            ...
            webSocketRequestEncoder: client.webSocketRequestEncoder,
    ...
    override init(isClientInActiveMode: Bool, syncRepository: SyncRepository, webSocketRequestEncoder: RequestEncoder?, webSocketClient: WebSocketClient?, apiClient: APIClient, timerType: TimerScheduling.Type) {
        super.init(
            isClientInActiveMode: isClientInActiveMode,
            syncRepository: syncRepository,
            webSocketRequestEncoder: webSocketRequestEncoder,
