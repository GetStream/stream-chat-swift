...
## StreamChat
### 🐞 Fixed
- Saving payloads to local database is not 50% faster. Initial launch and displaying channel list should be noticably faster [#1973](https://github.com/GetStream/stream-chat-swift/issues/1973)
