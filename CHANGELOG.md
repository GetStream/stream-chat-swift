...
### 🔄 Changed
- Minor breaking change in the testing framework. Some mock classes were made internal and now require a `@testable` annotation. [#3509](https://github.com/GetStream/stream-chat-swift/pull/3509)
