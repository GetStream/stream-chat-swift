...
- Fix crash in `ChannelVC` when it's initialized using a `ChannelController` created with `createDirectMessageChannelWith` factory [#2095](https://github.com/GetStream/stream-chat-swift/issues/2095)
### 🔄 Changed
