...
### 🐞 Fixed
- Fix controllers having empty data when state changed to `.remoteDataFetched` with background mapping enabled [#3039](https://github.com/GetStream/stream-chat-swift/pull/3039)
- Fix showing empty search results with background mapping enabled [#3039](https://github.com/GetStream/stream-chat-swift/pull/3039)
