...
- Add `ChatClientConfig.isChannelLocalFilteringEnabled: Bool (default: true)`: When the flag is true the ChannelDTO will use the filter's predicate to create the fetchRequest [#2488](https://github.com/GetStream/stream-chat-swift/pull/2488)
