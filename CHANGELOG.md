...
- Fix the voice recording lock button being shown outside of the safe area on the iPhone Duo [#4287](https://github.com/GetStream/stream-chat-swift/pull/4287)
