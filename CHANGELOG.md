...
- Add `isChannelLocalFilteringEnabled` in `ChatClientConfig` to allow changing whether the Channels in ChannelList will be locally filtered [#2488](https://github.com/GetStream/stream-chat-swift/pull/2488)
