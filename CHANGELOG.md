...
## StreamChat
### ✅ Added
- Expose additional device data on `Device`: `pushProvider`, `pushProviderName`, `userId`, `disabled`, `disabledReason`, `hardwareId`, and `voip` [#4161](https://github.com/GetStream/stream-chat-swift/pull/4161)
