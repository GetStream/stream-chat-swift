...
extension Chat_Tests {
    final class TestEnvironment {
        ...
        private(set) var readStateSender: ReadStateSender!
        ...
        func chatEnvironment(usesMockedUpdaters: Bool) -> Chat.Environment {
            Chat.Environment(
                ...
                readStateSenderBuilder: { [unowned self] in
                    self.readStateSender = ReadStateSender(cid: $0, channelUpdater: $1, authenticationRepository: $2, messageRepository: $3)
