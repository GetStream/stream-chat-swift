...
final class VoiceRecordingVC_Tests: XCTestCase {
    ...
    func test_updateContentByApplyingAction_send_contentLocationIsNotNilAndVoiceRecordingConfirmInsteadOfSendDisabled_wasConfiguredAsExpected() {
        var components = subject.components
        components.voiceRecordingConfirmInsteadOfSendEnabled = false
        subject.components = components
        var content = subject.content
    ...
    func test_updateContentByApplyingAction_send_contentLocationIsNotNilAndVoiceRecordingConfirmInsteadOfSendEnabled_wasConfiguredAsExpected() {
        var components = subject.components
        components.voiceRecordingConfirmInsteadOfSendEnabled = true
        subject.components = components
        var content = subject.content
        content.location = .unique()
        subject.content = content
    ...
    func test_updateContentByApplyingAction_confirm_contentLocationIsNotNilAndVoiceRecordingConfirmInsteadOfSendEnabled_wasConfiguredAsExpected() {
        var components = subject.components
        components.voiceRecordingConfirmInsteadOfSendEnabled = true
        subject.components = components
        var content = subject.content
    ...
    func test_updateContentByApplyingAction_publishMessage_contentLocationIsNotNilAndVoiceRecordingConfirmInsteadOfSendEnabled_wasConfiguredAsExpected() {
        var components = subject.components
        components.voiceRecordingConfirmInsteadOfSendEnabled = true
        subject.components = components
        var content = subject.content
    ...
    func test_didPanHorizontally_noDistanceCovered_slideToCancelViewWasConfiguredCorrectly() {
        ...
        XCTAssertEqual(subject.slideToCancelView.content, .init(title: "Slide to cancel", alpha: 1))
    }
    ...
    func test_didPanHorizontally_halfDistanceCovered_slideToCancelViewWasConfiguredCorrectly() {
        ...
        XCTAssertEqual(subject.slideToCancelView.content, .init(title: "Slide to cancel", alpha: 0.5))
    }
    ...
    func test_didPanHorizontally_distanceCovered_slideToCancelViewWasConfiguredCorrectly() {
        ...
        XCTAssertEqual(subject.slideToCancelView.content, .init(title: "Slide to cancel", alpha: 0))
    }
    ...
    func test_audioRecorderDidFinishRecordingAtURL_waveformVisualisationSucceedsSendImmediatelyIsTrueAndVoiceRecordingConfirmInsteadOfSendEnabled_updateContentByApplyingActionWasCalledAsExpected() {
        let location = URL.unique()
        var components = subject.components
        components.voiceRecordingConfirmInsteadOfSendEnabled = true
        subject.components = components
    ...
    private func assertViewController(
        ...
        AssertSnapshot(viewController.view, variants: .onlyUserInterfaceStyles, line: line, file: file, function: function)
    }
}
