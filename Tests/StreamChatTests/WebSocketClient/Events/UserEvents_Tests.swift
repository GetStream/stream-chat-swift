...
final class UserEvents_Tests: XCTestCase {
    ...
    func test_userPresenceEvent() throws {
        let json = XCTestCase.mockData(fromFile: "UserPresence", bundle: .testToolsBundle)
    ...
    func test_watchingEvent() throws {
        var json = XCTestCase.mockData(fromFile: "UserStartWatching", bundle: .testToolsBundle)
        ...
        json = XCTestCase.mockData(fromFile: "UserStopWatching", bundle: .testToolsBundle)
    ...
    func test_userBannedEvent() throws {
        let json = XCTestCase.mockData(fromFile: "UserBanned", bundle: .testToolsBundle)
    ...
    func test_userUnbannedEvent() throws {
        let json = XCTestCase.mockData(fromFile: "UserUnbanned", bundle: .testToolsBundle)
...
final class UserEventsIntegration_Tests: XCTestCase {
    ...
    func test_UserWatchingStartEventPayload_isHandled() throws {
        let json = XCTestCase.mockData(fromFile: "UserStartWatching", bundle: .testToolsBundle)
    ...
    func test_UserWatchingStoppedEventPayload_isHandled() throws {
        let json = XCTestCase.mockData(fromFile: "UserStopWatching", bundle: .testToolsBundle)
        let event = try eventDecoder.decode(from: json) as? UserWatchingEventDTO
    ...
    func test_UserUpdatedPayload_isHandled() throws {
        let json = XCTestCase.mockData(fromFile: "UserUpdated", bundle: .testToolsBundle)
