...
final class ChannelEventsIntegration_Tests: XCTestCase {
    ...
    func test_ChannelUpdatedEventPayload_isHandled() throws {
        let json = XCTestCase.mockData(fromFile: "ChannelUpdated", bundle: .testToolsBundle)
    ...
    func test_ChannelDeletedEventPayload_isHandled() throws {
        let json = XCTestCase.mockData(fromFile: "ChannelDeleted", bundle: .testToolsBundle)
    ...
    func test_ChannelTruncatedEventPayload_isHandled() throws {
        let json = XCTestCase.mockData(fromFile: "ChannelTruncated", bundle: .testToolsBundle)
    ...
    func test_ChannelVisibleEventPayload_isHandled() throws {
        let json = XCTestCase.mockData(fromFile: "ChannelVisible", bundle: .testToolsBundle)
    ...
    func test_ChannelHiddenEventPayload_isHandled() throws {
        let json = XCTestCase.mockData(fromFile: "ChannelHidden", bundle: .testToolsBundle)
