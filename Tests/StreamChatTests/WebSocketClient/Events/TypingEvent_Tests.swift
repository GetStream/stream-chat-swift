...
final class TypingEvent_Tests: XCTestCase {
    ...
    func test_parseTypingStartEvent() throws {
        let json = XCTestCase.mockData(fromFile: "UserStartTyping", bundle: .testToolsBundle)
    ...
    func test_parseTypingStoptEvent() throws {
        let json = XCTestCase.mockData(fromFile: "UserStopTyping", bundle: .testToolsBundle)
        guard let event = try eventDecoder.decode(from: json) as? TypingEventDTO else {
            XCTFail()
            return
        }
    ...
    func test_parseTypingStartEventInThread() throws {
        let json = XCTestCase.mockData(fromFile: "UserStartTypingThread", bundle: .testToolsBundle)
        guard let event = try eventDecoder.decode(from: json) as? TypingEventDTO else {
            XCTFail()
            return
        }
    ...
    func test_parseTypingStoptEventInThread() throws {
        let json = XCTestCase.mockData(fromFile: "UserStopTypingThread", bundle: .testToolsBundle)
        guard let event = try eventDecoder.decode(from: json) as? TypingEventDTO else {
            XCTFail()
            return
        }
