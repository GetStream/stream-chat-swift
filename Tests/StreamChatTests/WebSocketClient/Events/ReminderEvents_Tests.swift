...
final class ReminderEvents_Tests: XCTestCase {
    ...
    func test_reminderCreatedEvent_decoding() throws {
        ...
        let event = try eventDecoder.decode(from: json).unwrappedEvent as? ReminderCreatedEventDTO
    ...
    func test_reminderUpdatedEvent_decoding() throws {
        ...
        let event = try eventDecoder.decode(from: json).unwrappedEvent as? ReminderUpdatedEventDTO
    ...
    func test_reminderDeletedEvent_decoding() throws {
        ...
        let event = try eventDecoder.decode(from: json).unwrappedEvent as? ReminderDeletedEventDTO
    ...
    func test_reminderDueEvent_decoding() throws {
        ...
        let event = try eventDecoder.decode(from: json).unwrappedEvent as? ReminderNotificationEventDTO
