...
extension CustomDataHashMap_Tests {
    func assertEmptyCustomData<T>(
        _ entity: T.Type,
        _ fileName: String,
        file: StaticString = #filePath,
        line: UInt = #line
    ) throws where T: DecodableEntity {
        ...
        XCTAssertEqual(payload.extraData, [:], file: file, line: line)
    }

    func assertCustomData<T>(
        _ entity: T.Type,
        _ fileName: String,
        file: StaticString = #filePath,
        line: UInt = #line
        ...
        XCTAssertEqual(payload.extraData["secret_note"], .string("Anakin is Vader!"), file: file, line: line)
        XCTAssertEqual(payload.extraData["good_movies_count"], .number(3), file: file, line: line)
        XCTAssertEqual(payload.extraData["awesome"], .bool(true), file: file, line: line)
