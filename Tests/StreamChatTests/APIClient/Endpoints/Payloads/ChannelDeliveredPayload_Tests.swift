...
final class ChannelDeliveredPayload_Tests: XCTestCase {
    func test_deliveredMessagePayload_encodesCorrectly() throws {
        ...
        let payload = DeliveredMessagePayloadOpenAPI(cid: cid, id: messageId)
    ...
    func test_channelDeliveredRequestPayload_encodesCorrectly() throws {
        ...
        let deliveredMessage1 = DeliveredMessagePayloadOpenAPI(cid: cid1, id: messageId1)
        
        let cid2 = ChannelId(type: .livestream, id: "test-channel-2")
        let messageId2 = MessageId.unique
        let deliveredMessage2 = DeliveredMessagePayloadOpenAPI(cid: cid2, id: messageId2)
        
        let payload = MarkDeliveredRequest(latestDeliveredMessages: [deliveredMessage1, deliveredMessage2])
