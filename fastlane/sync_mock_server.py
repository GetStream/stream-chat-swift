...
stream_token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoibHVrZV9za3l3YWxrZXIifQ.kFSLHRB5X62t0Zlc7nwczWUfsQMwfkpylC6jCUZ6Mc0'
stream_user_id = 'luke_skywalker'
stream_headers = { 'Authorization' : stream_token, 'Stream-Auth-Type' : 'jwt' }
