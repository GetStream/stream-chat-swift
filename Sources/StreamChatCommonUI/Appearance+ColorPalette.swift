...
public extension Appearance {
    final class ColorPalette: @unchecked Sendable {
        ...
        public lazy var accentBlack: UIColor = .baseBlack
        public lazy var accentError: UIColor = UIColor(light: .red500, dark: .red400)
        public lazy var accentNeutral: UIColor = UIColor(light: .slate500, dark: .neutral600)
        public lazy var accentPrimary: UIColor = brand500
        ...
        public lazy var avatarBackgroundPlaceholder: UIColor = UIColor(light: .slate100, dark: .neutral700)
        public lazy var avatarPaletteBackground1: UIColor = UIColor(light: .blue100, dark: .blue800)
        public lazy var avatarPaletteBackground2: UIColor = UIColor(light: .cyan100, dark: .cyan800)
        public lazy var avatarPaletteBackground3: UIColor = UIColor(light: .green100, dark: .green800)
        public lazy var avatarPaletteBackground4: UIColor = UIColor(light: .purple100, dark: .purple800)
        public lazy var avatarPaletteBackground5: UIColor = UIColor(light: .yellow100, dark: .yellow800)
        ...
        public lazy var avatarTextPlaceholder: UIColor = UIColor(light: .slate500, dark: .neutral400)
        public lazy var backgroundCoreApp: UIColor = backgroundElevationElevation0
        public lazy var backgroundCoreDisabled: UIColor = UIColor(light: .slate100, dark: .neutral800)
        public lazy var backgroundCoreHover: UIColor = UIColor(light: UIColor(hex: 0x1e252b0d), dark: UIColor(hex: 0xffffff1a))
        public lazy var backgroundCoreInverse: UIColor = UIColor(light: .slate900, dark: .neutral50)
        public lazy var backgroundCoreOverlay: UIColor = UIColor(light: UIColor(hex: 0xffffffbf), dark: UIColor(hex: 0x000000bf))
        public lazy var backgroundCoreOverlayDark: UIColor = UIColor(light: UIColor(hex: 0x00000040), dark: UIColor(hex: 0x00000080))
        public lazy var backgroundCoreOverlayLight: UIColor = UIColor(light: UIColor(hex: 0xffffffbf), dark: UIColor(hex: 0x000000bf))
        public lazy var backgroundCorePressed: UIColor = UIColor(light: UIColor(hex: 0x1e252b1a), dark: UIColor(hex: 0xffffff33))
        public lazy var backgroundCoreScrim: UIColor = UIColor(light: UIColor(hex: 0x00000040), dark: UIColor(hex: 0x000000bf))
        public lazy var backgroundCoreSelected: UIColor = UIColor(light: UIColor(hex: 0x1e252b26), dark: UIColor(hex: 0xffffff40))
        public lazy var backgroundCoreSurface: UIColor = UIColor(light: .slate100, dark: .neutral700)
        public lazy var backgroundCoreSurfaceStrong: UIColor = UIColor(light: .slate150, dark: .neutral600)
        public lazy var backgroundCoreSurfaceSubtle: UIColor = UIColor(light: .slate50, dark: .neutral800)
        ...
        public lazy var badgeBackgroundDefault: UIColor = backgroundElevationElevation1
        public lazy var badgeBackgroundError: UIColor = accentError
        public lazy var badgeBackgroundInverse: UIColor = backgroundCoreInverse
        ...
        public lazy var badgeBorder: UIColor = borderCoreOnDark
        public lazy var badgeText: UIColor = textPrimary
        public lazy var badgeTextInverse: UIColor = textOnDark
        public lazy var badgeTextOnAccent: UIColor = textOnAccent
        public lazy var borderCoreDefault: UIColor = UIColor(light: .slate150, dark: .neutral600)
        public lazy var borderCoreOnAccent: UIColor = .baseWhite
        public lazy var borderCoreOnDark: UIColor = UIColor(light: .baseWhite, dark: .neutral900)
        public lazy var borderCoreOnSurface: UIColor = UIColor(light: .slate200, dark: .neutral500)
        public lazy var borderCoreOpacity10: UIColor = UIColor(light: UIColor(hex: 0x0000001a), dark: UIColor(hex: 0xffffff33))
        public lazy var borderCoreOpacity25: UIColor = UIColor(light: UIColor(hex: 0x00000040), dark: UIColor(hex: 0xffffff40))
        public lazy var borderCoreStrong: UIColor = UIColor(light: .slate200, dark: .neutral500)
        public lazy var borderCoreSubtle: UIColor = UIColor(light: .slate100, dark: .neutral700)
        public lazy var borderUtilityDisabled: UIColor = UIColor(light: .slate100, dark: .neutral700)
        public lazy var borderUtilityError: UIColor = accentError
        public lazy var borderUtilityFocus: UIColor = UIColor(light: brand300, dark: brand700)
        public lazy var borderUtilitySelected: UIColor = accentPrimary
        public lazy var borderUtilitySuccess: UIColor = accentSuccess
        public lazy var borderUtilityWarning: UIColor = accentWarning
        private lazy var brand100: UIColor = UIColor(light: .blue100, dark: .blue800)
        private lazy var brand150: UIColor = UIColor(light: .blue150, dark: .blue700)
        private lazy var brand200: UIColor = UIColor(light: .blue200, dark: .blue600)
        private lazy var brand300: UIColor = UIColor(light: .blue300, dark: .blue500)
        private lazy var brand400: UIColor = .blue400
        private lazy var brand50: UIColor = UIColor(light: .blue50, dark: .blue900)
        private lazy var brand500: UIColor = UIColor(light: .blue500, dark: .blue300)
        private lazy var brand600: UIColor = UIColor(light: .blue600, dark: .blue200)
        private lazy var brand700: UIColor = UIColor(light: .blue700, dark: .blue150)
        private lazy var brand800: UIColor = UIColor(light: .blue800, dark: .blue100)
        private lazy var brand900: UIColor = UIColor(light: .blue900, dark: .blue50)
        public lazy var buttonDestructiveBackground: UIColor = accentError
        public lazy var buttonDestructiveBackgroundLiquidGlass: UIColor = backgroundElevationElevation0
        public lazy var buttonDestructiveBorder: UIColor = accentError
        public lazy var buttonDestructiveBorderOnDark: UIColor = textOnDark
        ...
        public lazy var buttonDestructiveTextOnDark: UIColor = textOnDark
        ...
        public lazy var buttonPrimaryBorderOnDark: UIColor = UIColor(light: borderCoreOnDark, dark: textOnDark)
        public lazy var buttonPrimaryText: UIColor = accentPrimary
        public lazy var buttonPrimaryTextOnAccent: UIColor = textOnAccent
        public lazy var buttonPrimaryTextOnDark: UIColor = textOnDark
        public lazy var buttonSecondaryBackground: UIColor = backgroundCoreSurface
        public lazy var buttonSecondaryBackgroundLiquidGlass: UIColor = backgroundElevationElevation0
        public lazy var buttonSecondaryBorder: UIColor = borderCoreDefault
        public lazy var buttonSecondaryBorderOnDark: UIColor = borderCoreOnDark
        public lazy var buttonSecondaryText: UIColor = textPrimary
        public lazy var buttonSecondaryTextOnAccent: UIColor = textPrimary
        public lazy var buttonSecondaryTextOnDark: UIColor = textOnDark
        public lazy var chatBackgroundAttachmentIncoming: UIColor = UIColor(light: .slate150, dark: .neutral700)
        public lazy var chatBackgroundAttachmentOutgoing: UIColor = brand150
        public lazy var chatBackgroundIncoming: UIColor = UIColor(light: .slate100, dark: .neutral800)
        public lazy var chatBackgroundOutgoing: UIColor = brand100
        public lazy var chatBackgroundTypingIndicator: UIColor = accentNeutral
        public lazy var chatBorderIncoming: UIColor = UIColor(light: .slate100, dark: .neutral800)
        public lazy var chatBorderOnChatIncoming: UIColor = UIColor(light: .slate300, dark: .neutral500)
        ...
        public lazy var chatPollProgressFillOutgoing: UIColor = UIColor(light: accentPrimary, dark: .baseWhite)
        ...
        public lazy var chatReplyIndicatorOutgoing: UIColor = UIColor(light: brand400, dark: brand700)
        ...
        public lazy var chatThreadConnectorIncoming: UIColor = UIColor(light: .slate200, dark: chatBackgroundIncoming)
        public lazy var chatThreadConnectorOutgoing: UIColor = UIColor(light: brand150, dark: chatBackgroundOutgoing)
        public lazy var chatWaveformBar: UIColor = borderCoreOpacity25
        public lazy var chatWaveformBarPlaying: UIColor = accentPrimary
        public lazy var chipBackground: UIColor = UIColor(light: brand100, dark: brand200)
        public lazy var chipText: UIColor = brand900
        public lazy var composerBackground: UIColor = backgroundElevationElevation1
        ...
        public lazy var controlPlayControlBackground: UIColor = accentBlack
        public lazy var controlPlayControlIcon: UIColor = textOnAccent
        public lazy var controlProgressBarFill: UIColor = UIColor(light: .slate500, dark: .neutral50)
        public lazy var controlProgressBarTrack: UIColor = UIColor(light: .slate200, dark: .neutral600)
        public lazy var controlRadiocheckBackground: UIColor = .baseTransparent0
        public lazy var controlRadiocheckBackgroundSelected: UIColor = UIColor(light: accentPrimary, dark: .baseWhite)
        public lazy var controlRadiocheckBorder: UIColor = borderCoreDefault
        public lazy var controlRadiocheckIconSelected: UIColor = textOnDark
        public lazy var controlRemoveControlBackground: UIColor = accentBlack
        public lazy var controlRemoveControlBorder: UIColor = borderCoreOnDark
        public lazy var controlRemoveControlIcon: UIColor = textOnAccent
        public lazy var controlToggleSwitchBackground: UIColor = backgroundCoreSurfaceStrong
        public lazy var controlToggleSwitchBackgroundDisabled: UIColor = backgroundCoreDisabled
        public lazy var controlToggleSwitchBackgroundSelected: UIColor = accentPrimary
        public lazy var controlToggleSwitchKnob: UIColor = backgroundElevationElevation4
        public lazy var inputBorderDefault: UIColor = borderCoreDefault
        public lazy var inputBorderFocus: UIColor = borderUtilitySelected
        public lazy var inputBorderHover: UIColor = borderCoreStrong
        ...
        public lazy var presenceBorder: UIColor = borderCoreOnDark
        public lazy var reactionBackground: UIColor = backgroundElevationElevation3
        public lazy var reactionBorder: UIColor = UIColor(light: borderCoreSubtle, dark: borderCoreStrong)
        public lazy var reactionEmoji: UIColor = textPrimary
        public lazy var reactionText: UIColor = textPrimary
        public lazy var skeletonGradientAccentBase: UIColor = UIColor(light: brand50, dark: brand150)
        public lazy var skeletonGradientAccentHighlight: UIColor = UIColor(light: .baseWhite, dark: brand200)
        public lazy var skeletonGradientDefaultBase: UIColor = UIColor(light: .slate50, dark: .neutral800)
        public lazy var skeletonGradientDefaultHighlight: UIColor = UIColor(light: .baseWhite, dark: .neutral600)
        public lazy var systemBackgroundBlur: UIColor = UIColor(light: UIColor(hex: 0xffffff03), dark: UIColor(hex: 0x00000003))
        public lazy var systemCaret: UIColor = UIColor(light: accentPrimary, dark: .baseWhite)
        ...
        public lazy var textDisabled: UIColor = UIColor(light: .slate300, dark: .neutral500)
        public lazy var textInverse: UIColor = UIColor(light: .baseWhite, dark: .baseBlack)
        public lazy var textLink: UIColor = UIColor(light: accentPrimary, dark: .baseWhite)
        public lazy var textOnAccent: UIColor = .baseWhite
        public lazy var textOnDark: UIColor = UIColor(light: .baseWhite, dark: .neutral900)
        public lazy var textPrimary: UIColor = UIColor(light: .slate900, dark: .baseWhite)
        public lazy var textSecondary: UIColor = UIColor(light: .slate700, dark: .neutral100)
        public lazy var textTertiary: UIColor = UIColor(light: .slate500, dark: .neutral300)
    }
}
