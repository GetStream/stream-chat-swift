...
public typealias ChatInputSlashCommandView = _ChatInputSlashCommandView<NoExtraData>

open class _ChatInputSlashCommandView<ExtraData: ExtraDataTypes>: _View, UIConfigProvider {
    // MARK: - Properties
