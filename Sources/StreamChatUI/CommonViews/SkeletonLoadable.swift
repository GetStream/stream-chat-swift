...
extension SkeletonLoadable where Self: AppearanceProvider {
    func makeAnimationGroup(previousGroup: CAAnimationGroup? = nil) -> CAAnimationGroup {
        ...
        animation1.fromValue = appearance.colorPalette.backgroundCoreSurfaceStrong.cgColor
        animation1.toValue = appearance.colorPalette.accentNeutral.cgColor
        ...
        animation2.fromValue = appearance.colorPalette.accentNeutral.cgColor
        animation2.toValue = appearance.colorPalette.backgroundCoreSurfaceStrong.cgColor
