...
public extension _UIConfig {
    struct ChannelList {
        ...
        internal var swipeableItemView: _ChatChannelSwipeableListItemView<ExtraData>.Type =
            _ChatChannelSwipeableListItemView<ExtraData>.self

        /// The subviews that compose the `swipeableItemView`.
        internal var swipeableItemSubviews: SwipeableItemSubviews = SwipeableItemSubviews()
