...
public extension _UIConfig {
    struct MessageListUI {
        ...
        internal var incomingMessageCell: _СhatMessageCollectionViewCell<ExtraData>.Type =
            СhatIncomingMessageCollectionViewCell<ExtraData>.self
        internal var outgoingMessageCell: _СhatMessageCollectionViewCell<ExtraData>.Type =
            СhatOutgoingMessageCollectionViewCell<ExtraData>.self
        
        internal var incomingMessageAttachmentCell: _СhatMessageCollectionViewCell<ExtraData>.Type =
            СhatIncomingMessageAttachmentCollectionViewCell<ExtraData>.self
        internal var outgoingMessageAttachmentCell: _СhatMessageCollectionViewCell<ExtraData>.Type =
        ...
        internal var messageAttachmentContentView: _ChatMessageAttachmentContentView<ExtraData>
    ...
    struct MessageContentViewSubviews {
        ...
        internal var attachmentBubbleView: _ChatMessageAttachmentBubbleView<ExtraData>
