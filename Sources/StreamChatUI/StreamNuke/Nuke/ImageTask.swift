...
final class ImageTask: Hashable, CustomStringConvertible, @unchecked Sendable {
    ...
    var events: AsyncStream<Event> { makeStream { $0 } }
    ...
    init(taskId: Int64, request: ImageRequest, isDataTask: Bool, pipeline: ImagePipeline, onEvent: ((Event, ImageTask) -> Void)?) {
        ...
        publicState = PublicState(priority: request.priority)
...
typealias AsyncImageTask = ImageTask
