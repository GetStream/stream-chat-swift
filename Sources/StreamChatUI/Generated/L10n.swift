...
internal enum L10n {
  ...
  internal enum Polls {
    ...
    /// Question
    internal static var question: String { L10n.tr("Localizable", "polls.question") }
    /// Poll Results
    internal static var resultsTitle: String { L10n.tr("Localizable", "polls.results-title") }
    /// Unknown
    internal static var unknownVoteAuthor: String { L10n.tr("Localizable", "polls.unknown-vote-author") }
    /// Update your Comment
