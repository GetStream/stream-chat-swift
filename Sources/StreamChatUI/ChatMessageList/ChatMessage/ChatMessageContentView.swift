...
public typealias ChatMessageTextContentView = _ChatMessageTextContentView<NoExtraData>

open class _ChatMessageTextContentView<ExtraData: ExtraDataTypes>: View, UIConfigProvider {
