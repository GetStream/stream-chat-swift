...
extension ChatMessageFileAttachmentListView {
    open class AudioView: _View, ThemeProvider, AudioPlayingDelegate {
        /// The delegate on which the view will forward events
        ...
        /// The configurator that will be used to update the view whenever a new update occurs.
        ...
        /// A helper method that is used to provided a central way to update the view with
        /// a playbackContext
        ...
        /// The action that will be triggered when the leading (play/pause) button is tapped
        ...
        /// The action that will be triggered when the trailing (change rate) button is tapped
        ...
        /// The action that will be triggered when the user slide the progress view with the intention to
        /// play the audio track at another point in its timeline
