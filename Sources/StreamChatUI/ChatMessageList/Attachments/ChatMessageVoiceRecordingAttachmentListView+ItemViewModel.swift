...
extension ChatMessageVoiceRecordingAttachmentListView {
    /// The ViewModel that drives interactions and events for
    internal class ItemViewPresenter: AudioPlayingDelegate {
        /// The delegate to which the ViewModel will forward all audioPlayback events.
        internal weak var delegate: VoiceRecordingAttachmentPresentationViewDelegate?

        /// The view that holds the reference to this ViewModel.
        ...
        private var isFirstSetup: Bool = true
        ...
        internal func audioPlayer(
            ...
            let contentDuration = content.extraData?.duration ?? contextForViewUpdate.duration
