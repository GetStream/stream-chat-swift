...
class SwiftyGifManager {
    ...
    func addImageView(_ imageView: PlatformImageView) -> Bool {
    ...
    func deleteImageView(_ imageView: PlatformImageView) {
    ...
    func updateCacheSize(for imageView: PlatformImageView, add: Bool) {
