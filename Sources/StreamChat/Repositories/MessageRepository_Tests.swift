...
class MessageRepositoryTests: XCTestCase {
    ...
    func test_markMessage_nil() throws {
        ...
        updateMessageLocalState(id: id, to: nil)
    ...
    func test_markMessage_deleting() throws {
        ...
        updateMessageLocalState(id: id, to: .deleting)
    ...
    private func updateMessageLocalState(id: MessageId, to state: LocalMessageState?) {
