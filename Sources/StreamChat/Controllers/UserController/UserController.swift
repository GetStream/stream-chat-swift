...
public extension ChatUserController {
    ...
    func mute(completion: (@MainActor @Sendable(Error?) -> Void)? = nil) {
    ...
    /// - Parameter completion: The completion. Will be called on a **callbackQueue** when the network request is finished.
    ///
    func unmute(completion: (@MainActor @Sendable(Error?) -> Void)? = nil) {
    ...
    /// - Parameter completion: The completion. Will be called on a **callbackQueue** when the network request is finished.
    ///                         If request fails, the completion will be called with an error.
    func block(completion: (@MainActor @Sendable(Error?) -> Void)? = nil) {
    ...
    /// - Parameter completion: The completion. Will be called on a **callbackQueue** when the network request is finished.
    ///
    func unblock(completion: (@MainActor @Sendable(Error?) -> Void)? = nil) {
    ...
    /// - Parameter completion: The completion. Will be called on a **callbackQueue** when the network request is finished.
    ///
    func unflag(completion: (@MainActor @Sendable(Error?) -> Void)? = nil) {
