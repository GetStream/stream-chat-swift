...
public class API: DefaultAPIEndpoints {
    ...
    public func markUnread(type: String, id: String, markUnreadRequest: MarkUnreadRequest, isRecoveryOperation: Bool = false, completion: @escaping (Result<DefaultResponse, Error>) -> Void) {
        var connectionIdRequired: Bool
        connectionIdRequired = false
        var tokenRequired: Bool
        tokenRequired = true
    ...
    public func deleteDevice(id: String?, userId: String?, isRecoveryOperation: Bool = false, completion: @escaping (Result<DefaultResponse, Error>) -> Void) {
        var connectionIdRequired: Bool
        connectionIdRequired = false
        var tokenRequired: Bool
        tokenRequired = true
    ...
    public func ban(banRequest: BanRequest, isRecoveryOperation: Bool = false, completion: @escaping (Result<DefaultResponse, Error>) -> Void) {
        var connectionIdRequired: Bool
        connectionIdRequired = false
        var tokenRequired: Bool
        tokenRequired = true
    ...
    public func unban(targetUserId: String?, type: String?, id: String?, createdBy: String?, isRecoveryOperation: Bool = false, completion: @escaping (Result<DefaultResponse, Error>) -> Void) {
        var connectionIdRequired: Bool
        connectionIdRequired = false
        var tokenRequired: Bool
        tokenRequired = true
