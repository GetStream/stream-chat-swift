...
public struct StreamChatGetOrCreateCallResponse: Codable, Hashable {
    ...
    public init(membership: StreamChatMemberResponse?, ownCapabilities: [StreamChatOwnCapability], call: StreamChatCallResponse, created: Bool, duration: String, members: [StreamChatMemberResponse]) {
