...
public struct ThreadStateResponse: Codable, Hashable {
    ...
    public var latestReplies: [Message]
    ...
    public init(channelCid: String, createdAt: Date, createdByUserId: String, parentMessageId: String, title: String, updatedAt: Date, latestReplies: [Message], custom: [String: RawJSON], deletedAt: Date? = nil, lastMessageAt: Date? = nil, participantCount: Int? = nil, replyCount: Int? = nil, read: [Read?]? = nil, threadParticipants: [ThreadParticipant?]? = nil, channel: ChannelResponse? = nil, createdBy: UserObject? = nil, parentMessage: Message? = nil) {
