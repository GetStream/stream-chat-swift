...
public struct StreamChatApp: Codable, Hashable {
    ...
    public var callTypes: [String: StreamChatCallType?]
    ...
    public var policies: [String: [StreamChatPolicy]]
    ...
    public var geofences: [StreamChatGeofenceResponse?]? = nil
    
    public var imageModerationLabels: [String]? = nil
    
    public var agoraOptions: StreamChatConfig? = nil
    
    public var datadogInfo: StreamChatDataDogInfo? = nil
    
    public var hmsOptions: StreamChatConfig? = nil
    
    public init(asyncUrlEnrichEnabled: Bool, campaignEnabled: Bool, cdnExpirationSeconds: Int, customActionHandlerUrl: String, disableAuthChecks: Bool, disablePermissionsChecks: Bool, enforceUniqueUsernames: String, imageModerationEnabled: Bool, multiTenantEnabled: Bool, name: String, organization: String, permissionVersion: String, remindersInterval: Int, snsKey: String, snsSecret: String, snsTopicArn: String, sqsKey: String, sqsSecret: String, sqsUrl: String, suspended: Bool, suspendedExplanation: String, videoProvider: String, webhookUrl: String, userSearchDisallowedRoles: [String], webhookEvents: [String], callTypes: [String: StreamChatCallType?], channelConfigs: [String: StreamChatChannelConfig?], fileUploadConfig: StreamChatFileUploadConfig, grants: [String: [String]], imageUploadConfig: StreamChatFileUploadConfig, policies: [String: [StreamChatPolicy]], pushNotifications: StreamChatPushNotificationFields, autoTranslationEnabled: Bool? = nil, beforeMessageSendHookUrl: String? = nil, revokeTokensIssuedBefore: Date? = nil, allowedFlagReasons: [String]? = nil, geofences: [StreamChatGeofenceResponse?]? = nil, imageModerationLabels: [String]? = nil, agoraOptions: StreamChatConfig? = nil, datadogInfo: StreamChatDataDogInfo? = nil, hmsOptions: StreamChatConfig? = nil) {
