...
public struct StreamChatUserResponse: Codable, Hashable {
    ...
    public init(banned: Bool, id: String, online: Bool, role: String, shadowBanned: Bool, custom: [String: RawJSON], banExpires: Date? = nil, createdAt: Date? = nil, deactivatedAt: Date? = nil, deletedAt: Date? = nil, invisible: Bool? = nil, language: String? = nil, lastActive: Date? = nil, revokeTokensIssuedBefore: Date? = nil, updatedAt: Date? = nil, teams: [String]? = nil, pushNotifications: StreamChatPushNotificationSettings? = nil) {
        self.banned = banned
