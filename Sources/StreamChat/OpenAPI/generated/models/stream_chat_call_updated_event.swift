...
public struct StreamChatCallUpdatedEvent: Codable, Hashable {
    ...
    public init(call: StreamChatCallResponse, callCid: String, capabilitiesByRole: [String: RawJSON], createdAt: String, type: String) {
        self.call = call
