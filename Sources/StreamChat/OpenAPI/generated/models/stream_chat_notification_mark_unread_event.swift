...
public struct StreamChatNotificationMarkUnreadEvent: Codable, Hashable, Event {
    ...
    public init(channelId: String, channelType: String, cid: String, createdAt: Date, firstUnreadMessageId: String, lastReadAt: Date, totalUnreadCount: Int, type: String, unreadChannels: Int, unreadCount: Int, unreadMessages: Int, lastReadMessageId: String? = nil, team: String? = nil, channel: StreamChatChannelResponse? = nil, user: StreamChatUserObject? = nil) {
