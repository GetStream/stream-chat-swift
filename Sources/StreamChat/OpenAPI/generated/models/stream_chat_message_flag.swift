...
public struct StreamChatMessageFlag: Codable, Hashable {
    ...
    public var moderationFeedback: StreamChatFlagFeedback? = nil
    
    public var moderationResult: StreamChatMessageModerationResult? = nil
    
    public var reviewedBy: StreamChatUserObject? = nil
    
    public var user: StreamChatUserObject? = nil
    
    public init(createdAt: Date, createdByAutomod: Bool, updatedAt: Date, approvedAt: Date? = nil, reason: String? = nil, rejectedAt: Date? = nil, reviewedAt: Date? = nil, custom: [String: RawJSON]? = nil, details: StreamChatFlagDetails? = nil, message: StreamChatMessage? = nil, moderationFeedback: StreamChatFlagFeedback? = nil, moderationResult: StreamChatMessageModerationResult? = nil, reviewedBy: StreamChatUserObject? = nil, user: StreamChatUserObject? = nil) {
