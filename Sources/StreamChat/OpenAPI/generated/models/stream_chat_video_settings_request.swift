...
public struct StreamChatVideoSettingsRequest: Codable, Hashable {
    ...
    public var targetResolution: StreamChatTargetResolutionRequest?
    
    public init(accessRequestEnabled: Bool?, cameraDefaultOn: Bool?, cameraFacing: String?, enabled: Bool?, targetResolution: StreamChatTargetResolutionRequest?) {
