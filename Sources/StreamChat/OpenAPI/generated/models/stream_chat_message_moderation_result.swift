...
public struct StreamChatMessageModerationResult: Codable, Hashable {
    ...
    public var aiModerationResponse: StreamChatModerationResponse? = nil
    
    public var moderationThresholds: StreamChatThresholds? = nil
    
    public init(action: String, createdAt: Date, messageId: String, updatedAt: Date, userBadKarma: Bool, userKarma: Double, blockedWord: String? = nil, blocklistName: String? = nil, moderatedBy: String? = nil, aiModerationResponse: StreamChatModerationResponse? = nil, moderationThresholds: StreamChatThresholds? = nil) {
        self.action = action
