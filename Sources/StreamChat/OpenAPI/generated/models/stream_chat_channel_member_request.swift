...
public struct StreamChatChannelMemberRequest: Codable, Hashable {
    ...
    public init(banExpires: Date? = nil, banned: Bool? = nil, channelRole: String? = nil, createdAt: Date? = nil, deletedAt: Date? = nil, inviteAcceptedAt: Date? = nil, inviteRejectedAt: Date? = nil, invited: Bool? = nil, isModerator: Bool? = nil, shadowBanned: Bool? = nil, status: String? = nil, updatedAt: Date? = nil, userId: String? = nil, user: StreamChatUserObjectRequest? = nil) {
