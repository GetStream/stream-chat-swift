...
class AsyncOperation: BaseOperation {
    ...
    private(set) var executionBlock: (AsyncOperation, @Sendable @escaping (_ output: Output) -> Void) -> Void
    ...
    init(maxRetries: Int = 0, executionBlock: @Sendable @escaping (AsyncOperation, @Sendable @escaping (_ output: Output) -> Void) -> Void) {
