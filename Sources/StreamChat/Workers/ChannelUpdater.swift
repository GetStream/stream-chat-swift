...
package class ChannelUpdater: Worker {
    private let channelRepository: ChannelRepository
    private let callRepository: CallRepository
    package let messageRepository: MessageRepository
    package let paginationStateHandler: MessagesPaginationStateHandling
    ...
    package var paginationState: MessagesPaginationState {
    ...
    ///   - completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func updateChannel(channelPayload: ChannelEditDetailPayload, completion: ((Error?) -> Void)? = nil) {
    ...
    ///   - completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func partialChannelUpdate(
    ...
    ///   - completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func muteChannel(cid: ChannelId, mute: Bool, expiration: Int? = nil, completion: ((Error?) -> Void)? = nil) {
    ...
    ///   - cid: The channel identifier.
    ///   - completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func deleteChannel(cid: ChannelId, completion: ((Error?) -> Void)? = nil) {
    ...
    ///   - completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func hideChannel(cid: ChannelId, clearHistory: Bool, completion: ((Error?) -> Void)? = nil) {
    ...
    ///   - completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func showChannel(cid: ChannelId, completion: ((Error?) -> Void)? = nil) {
    ...
    ///   - completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func markRead(cid: ChannelId, userId: UserId, completion: ((Error?) -> Void)? = nil) {
    ...
    ///   - completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func enableSlowMode(cid: ChannelId, cooldownDuration: Int, completion: ((Error?) -> Void)? = nil) {
    ...
    package func startWatching(cid: ChannelId, isInRecoveryMode: Bool, completion: ((Error?) -> Void)? = nil) {
    ...
    /// - Parameter completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func stopWatching(cid: ChannelId, completion: ((Error?) -> Void)? = nil) {
    ...
    ///   - completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func channelWatchers(query: ChannelWatcherListQuery, completion: ((Result<ChannelPayload, Error>) -> Void)? = nil) {
    ...
    /// - Parameter cid: Channel id of the channel to be watched
    /// - Parameter completion: Called when the API call is finished. Called with `Error` if the remote update fails.
    package func freezeChannel(_ freeze: Bool, cid: ChannelId, completion: ((Error?) -> Void)? = nil) {
    ...
    package func enrichUrl(_ url: URL, completion: @escaping (Result<LinkAttachmentPayload, Error>) -> Void) {
    ...
    package func loadPinnedMessages(
        in cid: ChannelId,
    ...
    package func deleteFile(in cid: ChannelId, url: String, completion: ((Error?) -> Void)? = nil) {
        apiClient.request(endpoint: .deleteFile(cid: cid, url: url), completion: {
            completion?($0.error)
        })
    }
    
    package func deleteImage(in cid: ChannelId, url: String, completion: ((Error?) -> Void)? = nil) {
...
extension ChannelUpdater {
    ...
    package struct ChannelUpdateActions {
        ...
        package init(memberListSorting: [Sorting<ChannelMemberListSortingKey>], resetMembers: Bool, resetWatchers: Bool) {
            self.memberListSorting = memberListSorting
            self.resetMembers = resetMembers
            self.resetWatchers = resetWatchers
        }
    }
}
