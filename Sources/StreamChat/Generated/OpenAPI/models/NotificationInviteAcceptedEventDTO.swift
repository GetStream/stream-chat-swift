...
final class NotificationInviteAcceptedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationInviteAcceptedEventDTO, rhs: NotificationInviteAcceptedEventDTO) -> Bool {
