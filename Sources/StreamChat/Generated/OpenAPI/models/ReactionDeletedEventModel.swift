...
final class ReactionDeletedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ReactionDeletedEventModel, rhs: ReactionDeletedEventModel) -> Bool {
