...
final class NotificationThreadMessageNewEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationThreadMessageNewEventDTO, rhs: NotificationThreadMessageNewEventDTO) -> Bool {
