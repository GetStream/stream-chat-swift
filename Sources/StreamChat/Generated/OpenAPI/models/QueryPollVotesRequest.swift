...
final class QueryPollVotesRequest: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: QueryPollVotesRequest, rhs: QueryPollVotesRequest) -> Bool {
