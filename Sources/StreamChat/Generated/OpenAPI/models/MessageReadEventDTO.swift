...
final class MessageReadEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageReadEventDTO, rhs: MessageReadEventDTO) -> Bool {
