...
final class ThreadParticipantModel: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    var appPk: Int
    ...
    static func == (lhs: ThreadParticipantModel, rhs: ThreadParticipantModel) -> Bool {
        lhs.appPk == rhs.appPk &&
