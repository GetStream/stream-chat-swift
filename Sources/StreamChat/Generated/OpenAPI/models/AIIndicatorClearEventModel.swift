...
final class AIIndicatorClearEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: AIIndicatorClearEventModel, rhs: AIIndicatorClearEventModel) -> Bool {
