...
final class ReminderUpdatedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ReminderUpdatedEvent, rhs: ReminderUpdatedEvent) -> Bool {
        lhs.cid == rhs.cid &&
