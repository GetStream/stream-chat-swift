...
final class NotificationInvitedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "notification.invited"
    ...
    static func == (lhs: NotificationInvitedEventDTO, rhs: NotificationInvitedEventDTO) -> Bool {
