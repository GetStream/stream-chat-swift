...
final class NotificationMarkReadEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationMarkReadEventOpenAPI, rhs: NotificationMarkReadEventOpenAPI) -> Bool {
