...
final class ReminderNotificationEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ReminderNotificationEvent, rhs: ReminderNotificationEvent) -> Bool {
        lhs.cid == rhs.cid &&
