...
final class NotificationRemovedFromChannelEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationRemovedFromChannelEventOpenAPI, rhs: NotificationRemovedFromChannelEventOpenAPI) -> Bool {
