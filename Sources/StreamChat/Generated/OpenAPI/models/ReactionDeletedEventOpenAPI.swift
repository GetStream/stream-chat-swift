...
final class ReactionDeletedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ReactionDeletedEventOpenAPI, rhs: ReactionDeletedEventOpenAPI) -> Bool {
