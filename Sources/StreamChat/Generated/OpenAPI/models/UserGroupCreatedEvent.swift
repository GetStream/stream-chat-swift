...
final class UserGroupCreatedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserGroupCreatedEvent, rhs: UserGroupCreatedEvent) -> Bool {
