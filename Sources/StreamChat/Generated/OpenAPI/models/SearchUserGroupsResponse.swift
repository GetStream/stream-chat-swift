...
final class SearchUserGroupsResponse: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    var duration: String
    ...
    static func == (lhs: SearchUserGroupsResponse, rhs: SearchUserGroupsResponse) -> Bool {
