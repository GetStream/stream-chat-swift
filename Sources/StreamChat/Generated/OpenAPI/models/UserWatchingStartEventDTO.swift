...
final class UserWatchingStartEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "user.watching.start"
    ...
    static func == (lhs: UserWatchingStartEventDTO, rhs: UserWatchingStartEventDTO) -> Bool {
