...
final class UserGroupMemberAddedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserGroupMemberAddedEventDTO, rhs: UserGroupMemberAddedEventDTO) -> Bool {
