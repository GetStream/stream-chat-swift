...
final class UserPresenceChangedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserPresenceChangedEventDTO, rhs: UserPresenceChangedEventDTO) -> Bool {
