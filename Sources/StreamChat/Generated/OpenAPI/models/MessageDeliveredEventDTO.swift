...
final class MessageDeliveredEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageDeliveredEventDTO, rhs: MessageDeliveredEventDTO) -> Bool {
