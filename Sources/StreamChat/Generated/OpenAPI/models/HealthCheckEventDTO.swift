...
final class HealthCheckEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    var cid: String?
    ...
    static func == (lhs: HealthCheckEventDTO, rhs: HealthCheckEventDTO) -> Bool {
        lhs.cid == rhs.cid &&
