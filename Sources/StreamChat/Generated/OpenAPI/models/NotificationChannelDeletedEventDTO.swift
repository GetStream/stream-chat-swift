...
final class NotificationChannelDeletedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationChannelDeletedEventDTO, rhs: NotificationChannelDeletedEventDTO) -> Bool {
