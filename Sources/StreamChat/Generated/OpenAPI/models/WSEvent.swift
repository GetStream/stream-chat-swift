...
enum WSEvent: Codable, Hashable {
    ...
    case typeAIIndicatorClearEvent(AIIndicatorClearEvent)
    case typeAIIndicatorStopEvent(AIIndicatorStopEvent)
    case typeAIIndicatorUpdateEvent(AIIndicatorUpdateEvent)
    ...
    case typeDraftDeletedEvent(DraftDeletedEvent)
    case typeDraftUpdatedEvent(DraftUpdatedEvent)
    ...
    case typeMessageDeliveredEvent(MessageDeliveredEvent)
    ...
    case typeUserMessagesDeletedEvent(UserMessagesDeletedEvent)
    ...
    init(from decoder: Decoder) throws {
        ...
        if dto.type == "*" {
            ...
            let value = try container.decode(AIIndicatorClearEvent.self)
            self = .typeAIIndicatorClearEvent(value)
        } else if dto.type == "ai_indicator.stop" {
            let value = try container.decode(AIIndicatorStopEvent.self)
            self = .typeAIIndicatorStopEvent(value)
        } else if dto.type == "ai_indicator.update" {
            let value = try container.decode(AIIndicatorUpdateEvent.self)
            ...
            let value = try container.decode(DraftDeletedEvent.self)
            self = .typeDraftDeletedEvent(value)
        } else if dto.type == "draft.updated" {
            let value = try container.decode(DraftUpdatedEvent.self)
            ...
            let value = try container.decode(MessageDeliveredEvent.self)
            ...
            let value = try container.decode(UserMessagesDeletedEvent.self)
