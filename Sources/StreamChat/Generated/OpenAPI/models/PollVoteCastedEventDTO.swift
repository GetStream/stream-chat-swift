...
final class PollVoteCastedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PollVoteCastedEventDTO, rhs: PollVoteCastedEventDTO) -> Bool {
