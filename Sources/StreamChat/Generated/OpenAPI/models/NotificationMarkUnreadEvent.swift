...
final class NotificationMarkUnreadEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationMarkUnreadEvent, rhs: NotificationMarkUnreadEvent) -> Bool {
