...
final class ChatModerationV2Response: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    var action: String
    ...
    static func == (lhs: ChatModerationV2Response, rhs: ChatModerationV2Response) -> Bool {
