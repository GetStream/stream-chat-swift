...
final class MarkReadResponseEventDTO: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MarkReadResponseEventDTO, rhs: MarkReadResponseEventDTO) -> Bool {
