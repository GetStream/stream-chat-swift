...
final class PollVoteRemovedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "poll.vote_removed"
    ...
    static func == (lhs: PollVoteRemovedEventOpenAPI, rhs: PollVoteRemovedEventOpenAPI) -> Bool {
