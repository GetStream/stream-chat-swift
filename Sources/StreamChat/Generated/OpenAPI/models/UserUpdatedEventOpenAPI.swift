...
final class UserUpdatedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserUpdatedEventOpenAPI, rhs: UserUpdatedEventOpenAPI) -> Bool {
