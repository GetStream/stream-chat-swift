...
final class ChannelDeletedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelDeletedEventDTO, rhs: ChannelDeletedEventDTO) -> Bool {
