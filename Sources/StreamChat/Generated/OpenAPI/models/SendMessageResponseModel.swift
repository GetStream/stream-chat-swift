...
final class SendMessageResponseModel: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: SendMessageResponseModel, rhs: SendMessageResponseModel) -> Bool {
