...
final class AIIndicatorClearEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: AIIndicatorClearEvent, rhs: AIIndicatorClearEvent) -> Bool {
