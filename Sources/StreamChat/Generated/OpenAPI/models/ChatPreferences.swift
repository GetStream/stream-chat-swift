...
final class ChatPreferences: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    var channelMentions: String?
    var defaultPreference: String?
    var directMentions: String?
    var distinctChannelMessages: String?
    var groupMentions: String?
    var hereMentions: String?
    var roleMentions: String?
    var threadReplies: String?

    init(channelMentions: String? = nil, defaultPreference: String? = nil, directMentions: String? = nil, distinctChannelMessages: String? = nil, groupMentions: String? = nil, hereMentions: String? = nil, roleMentions: String? = nil, threadReplies: String? = nil) {
        self.channelMentions = channelMentions
        self.defaultPreference = defaultPreference
        self.directMentions = directMentions
        self.distinctChannelMessages = distinctChannelMessages
    ...
    enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case distinctChannelMessages = "distinct_channel_messages"
    ...
    func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(distinctChannelMessages)
