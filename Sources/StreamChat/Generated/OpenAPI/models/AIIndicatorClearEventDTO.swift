...
final class AIIndicatorClearEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: AIIndicatorClearEventDTO, rhs: AIIndicatorClearEventDTO) -> Bool {
