...
final class UserGroupMemberAddedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserGroupMemberAddedEvent, rhs: UserGroupMemberAddedEvent) -> Bool {
