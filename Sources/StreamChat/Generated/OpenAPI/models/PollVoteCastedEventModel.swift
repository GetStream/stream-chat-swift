...
final class PollVoteCastedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PollVoteCastedEventModel, rhs: PollVoteCastedEventModel) -> Bool {
