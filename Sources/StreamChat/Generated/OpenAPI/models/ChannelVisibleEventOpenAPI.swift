...
final class ChannelVisibleEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "channel.visible"
    ...
    static func == (lhs: ChannelVisibleEventOpenAPI, rhs: ChannelVisibleEventOpenAPI) -> Bool {
