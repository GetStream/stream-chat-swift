...
final class QueryChannelsRequest: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    init(filterConditions: [String: RawJSON]? = nil, filterValues: [String: RawJSON]? = nil, limit: Int? = nil, memberLimit: Int? = nil, messageLimit: Int? = nil, offset: Int? = nil, predefinedFilter: String? = nil, presence: Bool? = nil, sort: [SortParamRequest]? = nil, sortValues: [String: RawJSON]? = nil, state: Bool? = nil, watch: Bool? = nil) {
