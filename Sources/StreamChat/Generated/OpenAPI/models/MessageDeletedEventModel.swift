...
final class MessageDeletedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageDeletedEventModel, rhs: MessageDeletedEventModel) -> Bool {
