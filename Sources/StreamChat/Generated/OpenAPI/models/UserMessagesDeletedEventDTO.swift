...
final class UserMessagesDeletedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserMessagesDeletedEventDTO, rhs: UserMessagesDeletedEventDTO) -> Bool {
