...
final class PollDeletedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PollDeletedEventOpenAPI, rhs: PollDeletedEventOpenAPI) -> Bool {
