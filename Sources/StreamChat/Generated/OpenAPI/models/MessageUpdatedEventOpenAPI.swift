...
final class MessageUpdatedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageUpdatedEventOpenAPI, rhs: MessageUpdatedEventOpenAPI) -> Bool {
