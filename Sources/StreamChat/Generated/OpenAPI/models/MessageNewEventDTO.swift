...
final class MessageNewEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageNewEventDTO, rhs: MessageNewEventDTO) -> Bool {
