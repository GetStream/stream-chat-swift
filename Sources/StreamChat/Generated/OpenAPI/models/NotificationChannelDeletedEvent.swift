...
final class NotificationChannelDeletedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationChannelDeletedEvent, rhs: NotificationChannelDeletedEvent) -> Bool {
