...
final class MemberRemovedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MemberRemovedEventModel, rhs: MemberRemovedEventModel) -> Bool {
