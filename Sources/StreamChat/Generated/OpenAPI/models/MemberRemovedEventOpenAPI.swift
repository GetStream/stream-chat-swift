...
final class MemberRemovedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MemberRemovedEventOpenAPI, rhs: MemberRemovedEventOpenAPI) -> Bool {
