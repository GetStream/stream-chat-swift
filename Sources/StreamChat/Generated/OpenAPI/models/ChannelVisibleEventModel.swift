...
final class ChannelVisibleEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelVisibleEventModel, rhs: ChannelVisibleEventModel) -> Bool {
