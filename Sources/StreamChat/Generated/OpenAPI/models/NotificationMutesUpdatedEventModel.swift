...
final class NotificationMutesUpdatedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationMutesUpdatedEventModel, rhs: NotificationMutesUpdatedEventModel) -> Bool {
