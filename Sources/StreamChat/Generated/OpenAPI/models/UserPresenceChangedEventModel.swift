...
final class UserPresenceChangedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserPresenceChangedEventModel, rhs: UserPresenceChangedEventModel) -> Bool {
