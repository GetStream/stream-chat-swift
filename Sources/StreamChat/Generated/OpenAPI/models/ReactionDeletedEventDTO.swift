...
final class ReactionDeletedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ReactionDeletedEventDTO, rhs: ReactionDeletedEventDTO) -> Bool {
