...
final class DeleteReactionRequestPayload: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: DeleteReactionRequestPayload, rhs: DeleteReactionRequestPayload) -> Bool {
