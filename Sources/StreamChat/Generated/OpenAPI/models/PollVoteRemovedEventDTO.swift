...
final class PollVoteRemovedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PollVoteRemovedEventDTO, rhs: PollVoteRemovedEventDTO) -> Bool {
