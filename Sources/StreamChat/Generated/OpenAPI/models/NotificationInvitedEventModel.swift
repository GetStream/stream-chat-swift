...
final class NotificationInvitedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationInvitedEventModel, rhs: NotificationInvitedEventModel) -> Bool {
