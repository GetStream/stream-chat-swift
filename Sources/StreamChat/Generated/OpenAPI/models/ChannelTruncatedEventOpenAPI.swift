...
final class ChannelTruncatedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelTruncatedEventOpenAPI, rhs: ChannelTruncatedEventOpenAPI) -> Bool {
