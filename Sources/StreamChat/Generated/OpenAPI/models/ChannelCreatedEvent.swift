...
final class ChannelCreatedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelCreatedEvent, rhs: ChannelCreatedEvent) -> Bool {
