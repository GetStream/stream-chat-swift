...
final class UserBannedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserBannedEventOpenAPI, rhs: UserBannedEventOpenAPI) -> Bool {
