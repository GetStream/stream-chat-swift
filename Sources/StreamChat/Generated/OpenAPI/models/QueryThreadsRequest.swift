...
final class QueryThreadsRequest: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    init(filter: [String: RawJSON]? = nil, limit: Int? = nil, memberLimit: Int? = nil, next: String? = nil, participantLimit: Int? = nil, prev: String? = nil, replyLimit: Int? = nil, sort: [SortParamRequest]? = nil, watch: Bool? = nil) {
        self.filter = filter
        self.limit = limit
