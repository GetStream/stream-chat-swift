...
final class PushPreferenceInput: Sendable, Codable, JSONEncodable {
    ...
    let callLevel: PushPreferenceInputCallLevel?
    ...
    let feedsLevel: PushPreferenceInputFeedsLevel?
    ...
    init(
        callLevel: PushPreferenceInputCallLevel? = nil,
        channelCid: String? = nil,
        chatLevel: PushPreferenceInputChatLevel? = nil,
        disabledUntil: Date? = nil,
        feedsLevel: PushPreferenceInputFeedsLevel? = nil,
