...
final class ReminderCreatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "reminder.created"
    ...
    static func == (lhs: ReminderCreatedEventDTO, rhs: ReminderCreatedEventDTO) -> Bool {
        lhs.cid == rhs.cid &&
