...
final class DraftDeletedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: DraftDeletedEventOpenAPI, rhs: DraftDeletedEventOpenAPI) -> Bool {
        lhs.cid == rhs.cid &&
