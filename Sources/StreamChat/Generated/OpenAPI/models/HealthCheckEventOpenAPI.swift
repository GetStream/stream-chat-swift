...
final class HealthCheckEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    var cid: String?
    ...
    static func == (lhs: HealthCheckEventOpenAPI, rhs: HealthCheckEventOpenAPI) -> Bool {
        lhs.cid == rhs.cid &&
