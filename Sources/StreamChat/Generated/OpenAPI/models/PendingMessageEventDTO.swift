...
final class PendingMessageEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PendingMessageEventDTO, rhs: PendingMessageEventDTO) -> Bool {
