...
final class PollVoteChangedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PollVoteChangedEventDTO, rhs: PollVoteChangedEventDTO) -> Bool {
