...
final class ModerationCustomActionEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ModerationCustomActionEventDTO, rhs: ModerationCustomActionEventDTO) -> Bool {
