...
final class DraftDeletedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: DraftDeletedEventModel, rhs: DraftDeletedEventModel) -> Bool {
        lhs.cid == rhs.cid &&
