...
final class ThreadUpdatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ThreadUpdatedEventDTO, rhs: ThreadUpdatedEventDTO) -> Bool {
