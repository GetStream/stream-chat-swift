...
final class ChannelDeletedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelDeletedEvent, rhs: ChannelDeletedEvent) -> Bool {
