...
final class NotificationRemovedFromChannelEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationRemovedFromChannelEvent, rhs: NotificationRemovedFromChannelEvent) -> Bool {
