...
final class ChannelUpdatedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "channel.updated"
    ...
    static func == (lhs: ChannelUpdatedEventOpenAPI, rhs: ChannelUpdatedEventOpenAPI) -> Bool {
