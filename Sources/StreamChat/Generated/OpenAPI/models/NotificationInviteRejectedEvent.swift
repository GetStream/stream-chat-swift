...
final class NotificationInviteRejectedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationInviteRejectedEvent, rhs: NotificationInviteRejectedEvent) -> Bool {
