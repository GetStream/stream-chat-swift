...
final class NotificationMutesUpdatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationMutesUpdatedEventDTO, rhs: NotificationMutesUpdatedEventDTO) -> Bool {
