...
final class MemberAddedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MemberAddedEventOpenAPI, rhs: MemberAddedEventOpenAPI) -> Bool {
