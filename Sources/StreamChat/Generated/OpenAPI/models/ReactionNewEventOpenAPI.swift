...
final class ReactionNewEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ReactionNewEventOpenAPI, rhs: ReactionNewEventOpenAPI) -> Bool {
