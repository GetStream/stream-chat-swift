...
final class MemberAddedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MemberAddedEventDTO, rhs: MemberAddedEventDTO) -> Bool {
