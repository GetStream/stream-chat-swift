...
final class UserDeletedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserDeletedEventDTO, rhs: UserDeletedEventDTO) -> Bool {
