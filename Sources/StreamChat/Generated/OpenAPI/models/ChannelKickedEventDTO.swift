...
final class ChannelKickedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelKickedEventDTO, rhs: ChannelKickedEventDTO) -> Bool {
