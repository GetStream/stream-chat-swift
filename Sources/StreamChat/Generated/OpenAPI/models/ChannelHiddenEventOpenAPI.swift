...
final class ChannelHiddenEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelHiddenEventOpenAPI, rhs: ChannelHiddenEventOpenAPI) -> Bool {
