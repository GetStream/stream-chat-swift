...
final class NotificationChannelTruncatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationChannelTruncatedEventDTO, rhs: NotificationChannelTruncatedEventDTO) -> Bool {
