...
final class PollUpdatedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PollUpdatedEventOpenAPI, rhs: PollUpdatedEventOpenAPI) -> Bool {
