...
final class NotificationRemovedFromChannelEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationRemovedFromChannelEventModel, rhs: NotificationRemovedFromChannelEventModel) -> Bool {
