...
final class DeleteMessageRequestPayload: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: DeleteMessageRequestPayload, rhs: DeleteMessageRequestPayload) -> Bool {
