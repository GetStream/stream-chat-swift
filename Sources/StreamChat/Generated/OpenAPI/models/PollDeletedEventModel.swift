...
final class PollDeletedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PollDeletedEventModel, rhs: PollDeletedEventModel) -> Bool {
