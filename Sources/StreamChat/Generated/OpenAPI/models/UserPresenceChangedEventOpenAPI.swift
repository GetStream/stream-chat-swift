...
final class UserPresenceChangedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserPresenceChangedEventOpenAPI, rhs: UserPresenceChangedEventOpenAPI) -> Bool {
