...
final class NotificationMarkReadEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationMarkReadEvent, rhs: NotificationMarkReadEvent) -> Bool {
