...
final class MemberRemovedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MemberRemovedEventDTO, rhs: MemberRemovedEventDTO) -> Bool {
