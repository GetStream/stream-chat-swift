...
final class PollVoteCastedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "poll.vote_casted"
    ...
    static func == (lhs: PollVoteCastedEventOpenAPI, rhs: PollVoteCastedEventOpenAPI) -> Bool {
