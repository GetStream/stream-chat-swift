...
final class NotificationChannelDeletedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationChannelDeletedEventModel, rhs: NotificationChannelDeletedEventModel) -> Bool {
