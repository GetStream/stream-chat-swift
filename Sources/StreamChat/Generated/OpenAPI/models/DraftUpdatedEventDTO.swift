...
final class DraftUpdatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: DraftUpdatedEventDTO, rhs: DraftUpdatedEventDTO) -> Bool {
        lhs.cid == rhs.cid &&
