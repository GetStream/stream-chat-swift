...
final class TypingStartEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: TypingStartEventDTO, rhs: TypingStartEventDTO) -> Bool {
