...
final class NotificationInvitedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationInvitedEvent, rhs: NotificationInvitedEvent) -> Bool {
