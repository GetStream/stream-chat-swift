...
final class NotificationMarkUnreadEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationMarkUnreadEventDTO, rhs: NotificationMarkUnreadEventDTO) -> Bool {
