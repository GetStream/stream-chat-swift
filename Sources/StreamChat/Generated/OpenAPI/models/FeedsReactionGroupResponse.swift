...
final class FeedsReactionGroupResponse: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    var count: Int
    ...
    static func == (lhs: FeedsReactionGroupResponse, rhs: FeedsReactionGroupResponse) -> Bool {
        lhs.count == rhs.count &&
