...
final class PollUpdatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PollUpdatedEventDTO, rhs: PollUpdatedEventDTO) -> Bool {
