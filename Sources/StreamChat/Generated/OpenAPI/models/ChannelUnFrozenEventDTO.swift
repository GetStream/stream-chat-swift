...
final class ChannelUnFrozenEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelUnFrozenEventDTO, rhs: ChannelUnFrozenEventDTO) -> Bool {
