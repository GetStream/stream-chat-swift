...
final class ChannelUpdatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelUpdatedEventDTO, rhs: ChannelUpdatedEventDTO) -> Bool {
