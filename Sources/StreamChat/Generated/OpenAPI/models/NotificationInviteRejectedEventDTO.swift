...
final class NotificationInviteRejectedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "notification.invite_rejected"
    ...
    static func == (lhs: NotificationInviteRejectedEventDTO, rhs: NotificationInviteRejectedEventDTO) -> Bool {
