...
final class UserGroupMemberRemovedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserGroupMemberRemovedEventDTO, rhs: UserGroupMemberRemovedEventDTO) -> Bool {
