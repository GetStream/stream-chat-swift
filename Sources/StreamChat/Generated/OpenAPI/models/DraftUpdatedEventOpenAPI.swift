...
final class DraftUpdatedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: DraftUpdatedEventOpenAPI, rhs: DraftUpdatedEventOpenAPI) -> Bool {
        lhs.cid == rhs.cid &&
