...
final class MessageDeliveredEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageDeliveredEventOpenAPI, rhs: MessageDeliveredEventOpenAPI) -> Bool {
