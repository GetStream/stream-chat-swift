...
final class DraftPayloadResponseModel: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: DraftPayloadResponseModel, rhs: DraftPayloadResponseModel) -> Bool {
