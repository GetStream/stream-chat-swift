...
final class UserMessagesDeletedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserMessagesDeletedEventOpenAPI, rhs: UserMessagesDeletedEventOpenAPI) -> Bool {
