...
final class QueryRemindersRequest: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: QueryRemindersRequest, rhs: QueryRemindersRequest) -> Bool {
