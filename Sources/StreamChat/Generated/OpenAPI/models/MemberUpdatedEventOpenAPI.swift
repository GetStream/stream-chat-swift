...
final class MemberUpdatedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "member.updated"
    ...
    static func == (lhs: MemberUpdatedEventOpenAPI, rhs: MemberUpdatedEventOpenAPI) -> Bool {
