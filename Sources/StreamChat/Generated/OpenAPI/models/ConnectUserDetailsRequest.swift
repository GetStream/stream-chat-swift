...
final class ConnectUserDetailsRequest: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ConnectUserDetailsRequest, rhs: ConnectUserDetailsRequest) -> Bool {
