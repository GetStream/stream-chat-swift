...
final class MessageNewEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageNewEventModel, rhs: MessageNewEventModel) -> Bool {
