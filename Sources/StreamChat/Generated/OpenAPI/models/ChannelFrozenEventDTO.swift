...
final class ChannelFrozenEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelFrozenEventDTO, rhs: ChannelFrozenEventDTO) -> Bool {
