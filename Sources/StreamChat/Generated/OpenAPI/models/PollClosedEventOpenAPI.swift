...
final class PollClosedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PollClosedEventOpenAPI, rhs: PollClosedEventOpenAPI) -> Bool {
