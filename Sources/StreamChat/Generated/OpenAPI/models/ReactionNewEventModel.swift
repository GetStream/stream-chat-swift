...
final class ReactionNewEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ReactionNewEventModel, rhs: ReactionNewEventModel) -> Bool {
