...
final class MessageReadEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageReadEventOpenAPI, rhs: MessageReadEventOpenAPI) -> Bool {
