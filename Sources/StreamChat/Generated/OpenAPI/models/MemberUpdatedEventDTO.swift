...
final class MemberUpdatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MemberUpdatedEventDTO, rhs: MemberUpdatedEventDTO) -> Bool {
