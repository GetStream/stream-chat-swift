...
final class ChannelCreatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "channel.created"
    ...
    static func == (lhs: ChannelCreatedEventDTO, rhs: ChannelCreatedEventDTO) -> Bool {
