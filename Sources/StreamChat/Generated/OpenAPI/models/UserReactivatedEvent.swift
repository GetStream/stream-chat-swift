...
final class UserReactivatedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserReactivatedEvent, rhs: UserReactivatedEvent) -> Bool {
