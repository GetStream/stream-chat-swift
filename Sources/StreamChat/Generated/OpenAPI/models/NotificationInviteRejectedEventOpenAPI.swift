...
final class NotificationInviteRejectedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationInviteRejectedEventOpenAPI, rhs: NotificationInviteRejectedEventOpenAPI) -> Bool {
