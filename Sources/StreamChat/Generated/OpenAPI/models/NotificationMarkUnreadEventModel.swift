...
final class NotificationMarkUnreadEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationMarkUnreadEventModel, rhs: NotificationMarkUnreadEventModel) -> Bool {
