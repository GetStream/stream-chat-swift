...
final class UserMessagesDeletedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserMessagesDeletedEvent, rhs: UserMessagesDeletedEvent) -> Bool {
