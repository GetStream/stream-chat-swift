...
final class ChannelDeletedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelDeletedEventModel, rhs: ChannelDeletedEventModel) -> Bool {
