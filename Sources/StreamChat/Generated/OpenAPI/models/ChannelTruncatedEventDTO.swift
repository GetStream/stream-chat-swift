...
final class ChannelTruncatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ChannelTruncatedEventDTO, rhs: ChannelTruncatedEventDTO) -> Bool {
