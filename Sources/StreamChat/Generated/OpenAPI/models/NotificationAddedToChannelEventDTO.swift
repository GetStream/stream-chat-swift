...
final class NotificationAddedToChannelEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationAddedToChannelEventDTO, rhs: NotificationAddedToChannelEventDTO) -> Bool {
