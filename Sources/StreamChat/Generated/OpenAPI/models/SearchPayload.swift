...
final class SearchPayload: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    init(filterConditions: [String: RawJSON], forceDefaultSearch: Bool? = nil, forceSqlV2Backend: Bool? = nil, limit: Int? = nil, messageFilterConditions: [String: RawJSON]? = nil, messageOptions: MessageOptions? = nil, next: String? = nil, offset: Int? = nil, query: String? = nil, sort: [SortParamRequest]? = nil) {
