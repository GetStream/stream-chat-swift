...
final class MessageDeletedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageDeletedEventOpenAPI, rhs: MessageDeletedEventOpenAPI) -> Bool {
