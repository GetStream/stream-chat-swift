...
final class AIIndicatorUpdateEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: AIIndicatorUpdateEventModel, rhs: AIIndicatorUpdateEventModel) -> Bool {
