...
final class MemberUpdatedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MemberUpdatedEventModel, rhs: MemberUpdatedEventModel) -> Bool {
