...
final class AIIndicatorClearEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "ai_indicator.clear"
    ...
    static func == (lhs: AIIndicatorClearEventOpenAPI, rhs: AIIndicatorClearEventOpenAPI) -> Bool {
