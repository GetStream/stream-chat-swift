...
final class NotificationInvitedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationInvitedEventOpenAPI, rhs: NotificationInvitedEventOpenAPI) -> Bool {
