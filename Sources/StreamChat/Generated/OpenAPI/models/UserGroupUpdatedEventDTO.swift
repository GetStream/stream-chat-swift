...
final class UserGroupUpdatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserGroupUpdatedEventDTO, rhs: UserGroupUpdatedEventDTO) -> Bool {
