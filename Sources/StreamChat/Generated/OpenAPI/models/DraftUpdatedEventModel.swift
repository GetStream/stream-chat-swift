...
final class DraftUpdatedEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: DraftUpdatedEventModel, rhs: DraftUpdatedEventModel) -> Bool {
        lhs.cid == rhs.cid &&
