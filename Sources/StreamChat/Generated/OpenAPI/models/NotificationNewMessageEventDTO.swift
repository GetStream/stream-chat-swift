...
final class NotificationNewMessageEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationNewMessageEventDTO, rhs: NotificationNewMessageEventDTO) -> Bool {
