...
final class MessageDeletedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageDeletedEventDTO, rhs: MessageDeletedEventDTO) -> Bool {
