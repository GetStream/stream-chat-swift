...
final class ModerationFlaggedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ModerationFlaggedEventDTO, rhs: ModerationFlaggedEventDTO) -> Bool {
