...
final class ReminderUpdatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "reminder.updated"
    ...
    static func == (lhs: ReminderUpdatedEventDTO, rhs: ReminderUpdatedEventDTO) -> Bool {
        lhs.cid == rhs.cid &&
