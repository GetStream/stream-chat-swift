...
final class ReminderDeletedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ReminderDeletedEventDTO, rhs: ReminderDeletedEventDTO) -> Bool {
        lhs.cid == rhs.cid &&
