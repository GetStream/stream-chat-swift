...
final class PollDeletedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: PollDeletedEventDTO, rhs: PollDeletedEventDTO) -> Bool {
