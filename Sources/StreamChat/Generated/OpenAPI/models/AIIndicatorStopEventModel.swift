...
final class AIIndicatorStopEventModel: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: AIIndicatorStopEventModel, rhs: AIIndicatorStopEventModel) -> Bool {
