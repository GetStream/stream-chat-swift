...
final class ReactionUpdatedEventOpenAPI: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ReactionUpdatedEventOpenAPI, rhs: ReactionUpdatedEventOpenAPI) -> Bool {
