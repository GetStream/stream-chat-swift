...
final class ModerationMarkReviewedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    var createdAt: Date
    ...
    static func == (lhs: ModerationMarkReviewedEventDTO, rhs: ModerationMarkReviewedEventDTO) -> Bool {
