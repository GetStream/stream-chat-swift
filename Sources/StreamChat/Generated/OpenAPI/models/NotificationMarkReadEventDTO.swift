...
final class NotificationMarkReadEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationMarkReadEventDTO, rhs: NotificationMarkReadEventDTO) -> Bool {
