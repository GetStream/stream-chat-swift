...
final class UserUnbannedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserUnbannedEventDTO, rhs: UserUnbannedEventDTO) -> Bool {
