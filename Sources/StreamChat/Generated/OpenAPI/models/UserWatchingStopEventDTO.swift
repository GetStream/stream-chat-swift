...
final class UserWatchingStopEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: UserWatchingStopEventDTO, rhs: UserWatchingStopEventDTO) -> Bool {
