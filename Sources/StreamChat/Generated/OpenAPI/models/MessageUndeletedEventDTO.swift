...
final class MessageUndeletedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageUndeletedEventDTO, rhs: MessageUndeletedEventDTO) -> Bool {
