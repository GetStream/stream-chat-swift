...
final class AIIndicatorUpdateEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: AIIndicatorUpdateEvent, rhs: AIIndicatorUpdateEvent) -> Bool {
