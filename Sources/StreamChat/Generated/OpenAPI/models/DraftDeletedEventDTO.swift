...
final class DraftDeletedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: DraftDeletedEventDTO, rhs: DraftDeletedEventDTO) -> Bool {
        lhs.cid == rhs.cid &&
