...
final class DeleteCommentRequestPayload: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: DeleteCommentRequestPayload, rhs: DeleteCommentRequestPayload) -> Bool {
