...
final class MessageUpdatedEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: MessageUpdatedEventDTO, rhs: MessageUpdatedEventDTO) -> Bool {
