...
final class NotificationInviteAcceptedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: NotificationInviteAcceptedEvent, rhs: NotificationInviteAcceptedEvent) -> Bool {
