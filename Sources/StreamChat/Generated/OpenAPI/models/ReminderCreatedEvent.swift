...
final class ReminderCreatedEvent: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: ReminderCreatedEvent, rhs: ReminderCreatedEvent) -> Bool {
        lhs.cid == rhs.cid &&
