...
final class KeyframeOCRRuleParameters: @unchecked Sendable, Codable, JSONEncodable, Hashable {
    ...
    static func == (lhs: KeyframeOCRRuleParameters, rhs: KeyframeOCRRuleParameters) -> Bool {
