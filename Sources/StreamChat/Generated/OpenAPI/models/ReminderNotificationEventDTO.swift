...
final class ReminderNotificationEventDTO: @unchecked Sendable, Event, Codable, JSONEncodable, Hashable {
    ...
    var type: String = "notification.reminder_due"
    ...
    static func == (lhs: ReminderNotificationEventDTO, rhs: ReminderNotificationEventDTO) -> Bool {
        lhs.cid == rhs.cid &&
