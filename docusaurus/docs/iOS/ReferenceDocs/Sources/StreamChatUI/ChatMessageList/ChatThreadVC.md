...
id: chatthreadvc 
title: ChatThreadVC
slug: /ReferenceDocs/Sources/StreamChatUI/ChatMessageList/chatthreadvc
---
...
[`_ViewController`](../CommonViews/_ViewController), [`ChatMessageContentViewDelegate`](ChatMessage/ChatMessageContentViewDelegate), [`ComposerVCDelegate`](../Composer/ComposerVCDelegate), `UICollectionViewDataSource`, `_ChatChannelControllerDelegate`, [`_ChatMessageActionsVCDelegate`](../MessageActionsPopup/ChatMessageActionsVCDelegate), [`ThemeProvider`](../Utils/ThemeProvider), `UICollectionViewDelegate`, `_ChatMessageControllerDelegate`
