...
public final class CurrentUserControllerGeneric<ExtraData: ExtraDataTypes>: Controller, DelegateCallable {
    ...
    private let environment: Environment<ExtraData>
    ...
    init(client: Client<ExtraData>, environment: Environment<ExtraData>) {
        self.client = client
    ...
    func startUpdating(_ completion: ((Error?) -> Void)? = nil) {
        do {
...
extension CurrentUserControllerGeneric {
    struct Environment<ExtraData: ExtraDataTypes> {
