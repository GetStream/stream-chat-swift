...
extension _ChatClient {
    ...
    ///
    public func channelListController(query: ChannelListQuery<ExtraData>) -> _ChatChannelListController<ExtraData> {
...
public class _ChatChannelListController<ExtraData: ExtraDataTypes>: DataController, DelegateCallable, DataStoreProvider {
    ...
    public let query: ChannelListQuery<ExtraData>
    ...
    init(query: ChannelListQuery<ExtraData>, client: _ChatClient<ExtraData>, environment: Environment = .init()) {
        self.client = client
        self.query = query
