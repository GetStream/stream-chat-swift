...
class DemoChatThreadVC: ChatThreadVC, CurrentChatUserControllerDelegate {
    ...
    override func loadPreviousReplies(completion: @escaping @MainActor @Sendable(Error?) -> Void) {
    ...
    override func loadNextReplies(completion: @escaping @MainActor @Sendable(Error?) -> Void) {
