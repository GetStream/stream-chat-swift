...
final class SlackReactionsView: _View, ThemeProvider, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func updateContent() {
        ...
        collectionView.semanticContentAttribute = content.isSentByCurrentUser ? .forceRightToLeft : .forceLeftToRight
        ...
        let numberOfLines = CGFloat(reactions.count) * reactionWidth / UIScreen.main.bounds.width
        heightConstraint?.constant = ceil(numberOfLines) * reactionRowHeight
    }
